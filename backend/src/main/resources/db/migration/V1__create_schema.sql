...
CREATE TABLE passageiro (
    ...
    CONSTRAINT fk_passageiro_pessoa FOREIGN KEY (id_pessoa) REFERENCES pessoa(id)
);
...
CREATE TABLE reserva (
    ...
    integrado_transportadora BOOLEAN DEFAULT FALSE NOT NULL,
    ...
    CONSTRAINT ck_reserva_status     CHECK (status IN ('PENDENTE','CONFIRMADA','CANCELADA','EXPIRADA','AGUARDANDO_APROVACAO'))
);
